...
- Sempre utilizar conventional commits para mensagens de commit, seguindo o padrão de tipos e escopo para facilitar o entendimento e rastreabilidade das mudanças
